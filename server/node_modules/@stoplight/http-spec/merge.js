...
function mergeSchemas(schema1, schema2) {
    const schemas = (isExclusivelyAnyOfSchema(schema2) ? schema2.anyOf : [schema2]).reduce((schemas, schema) => {
        if (!schemas.find(s => lodash_1.isEqual(s, schema))) {
...
function mergeParams(params1, params2) {
    const params1OnlyAndCommon = params1.map(p1 => {
        ...
        if (p2) {
            return Object.assign(Object.assign(Object.assign({}, p2), p1), { required: p1.required && p2.required, schema: mergeTwo(mergeSchemas, p1.schema, p2.schema) });
        }
        else {
            return Object.assign(Object.assign({}, p1), { required: false });
        }
    });
    const params2Only = params2
        .filter(p2 => !params1.find(p1 => p1.name.toLowerCase() === p2.name.toLowerCase()))
        .map(h2 => (Object.assign(Object.assign({}, h2), { required: false })));
...
function mergeContentExamples(exampleLists) {
    return exampleLists.reduce((merged, examples) => {
        if (!examples)
            return merged;
        const arr = (Array.isArray(examples) ? examples : [examples]).filter(ex => !(merged || []).find(me => lodash_1.isEqual(me, ex)));
...
function mergeContentEncodings(encodingLists) {
    return encodingLists.reduce((merged, encodings) => {
        if (!encodings)
            return merged;
        const arr = encodings.filter(enc => !(merged || []).find(me => lodash_1.isEqual(me, enc)));
        return merged ? merged.concat(arr) : arr;
    }, undefined);
}
exports.mergeResponses = mergeLists((r1, r2) => r1.code === r2.code, (r1, r2) => (Object.assign(Object.assign({}, r1), { headers: mergeParams(r1.headers || [], r2.headers || []), contents: mergeContents(r1.contents || [], r2.contents || []) })));
...
exports.mergeOperations = mergeLists((o1, o2) => o1.path === o2.path && o1.method.toLowerCase() === o2.method.toLowerCase(), (o1, o2) => {
    ...
    return (Object.assign(Object.assign({}, o1), { request: Object.assign(Object.assign({}, o1.request), { path: mergeTwo(mergeParams, (_a = o1.request) === null || _a === void 0 ? void 0 : _a.path, (_b = o2.request) === null || _b === void 0 ? void 0 : _b.path), query: mergeTwo(mergeParams, (_c = o1.request) === null || _c === void 0 ? void 0 : _c.query, (_d = o2.request) === null || _d === void 0 ? void 0 : _d.query), body: mergeTwo(mergeRequestBodies, (_e = o1.request) === null || _e === void 0 ? void 0 : _e.body, (_f = o2.request) === null || _f === void 0 ? void 0 : _f.body), headers: mergeTwo(mergeParams, (_g = o1.request) === null || _g === void 0 ? void 0 : _g.headers, (_h = o2.request) === null || _h === void 0 ? void 0 : _h.headers) }), responses: exports.mergeResponses(o1.responses, o2.responses), servers: mergeServers(o1.servers || [], o2.servers || []) }));
});

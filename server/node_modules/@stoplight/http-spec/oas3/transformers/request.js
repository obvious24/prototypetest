...
function translateRequestBody(requestBodyObject) {
    return {
        ...
        contents: lodash_1.compact(lodash_1.map(requestBodyObject.content, content_1.translateMediaTypeObject)),
    };
}
function translateParameterObject(parameterObject) {
    return lodash_1.pickBy(Object.assign(Object.assign({}, lodash_1.omit(parameterObject, 'in', 'schema')), { name: parameterObject.name, style: parameterObject.style, schema: parameterObject.schema, examples: lodash_1.map(parameterObject.examples, (example, key) => (Object.assign({ key }, example))) }));
}

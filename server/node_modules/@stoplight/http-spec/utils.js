...
exports.maybeResolveLocalRef = exports.isDictionary = exports.URI = exports.mapToKeys = void 0;
const json_1 = require("@stoplight/json");
const lodash_1 = require("lodash");
const URIJS = require("urijs");
function mapToKeys(collection) {
...
exports.URI = URI;
exports.isDictionary = (maybeDictionary) => lodash_1.isObjectLike(maybeDictionary);
const getLocalRefValue = (document, $ref) => {
    return lodash_1.get(document, json_1.pointerToPath($ref));
};
exports.maybeResolveLocalRef = (document, target) => {
    if (json_1.hasRef(target) && json_1.isLocalRef(target.$ref)) {
        try {

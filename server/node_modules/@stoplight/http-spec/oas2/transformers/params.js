...
function translateToHeaderParam(parameter) {
    return lodash_1.pickBy(Object.assign(Object.assign({}, buildSchemaForParameter(parameter)), { name: parameter.name, style: types_1.HttpParamStyles.Simple, required: parameter.required }));
}
...
function translateToQueryParameter(query) {
    return lodash_1.pickBy(Object.assign(Object.assign({}, buildSchemaForParameter(query)), { allowEmptyValue: query.allowEmptyValue, name: query.name, style: chooseQueryParameterStyle(query), required: query.required }));
}
...
function buildSchemaForParameter(param) {
    ...
    return Object.assign({ schema, description: param.description }, ('x-deprecated' in param && { deprecated: param['x-deprecated'] }));
}

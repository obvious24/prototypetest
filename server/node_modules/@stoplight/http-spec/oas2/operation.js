...
function transformOas2Operations(document) {
    return operation_1.transformOasOperations(document, exports.transformOas2Operation);
}
...
exports.transformOas2Operation = ({ document, path, method }) => {
    ...
    const httpOperation = {
        ...
        responses: responses_1.translateToResponses(document, operation.responses, produces),
        servers: servers_1.translateToServers(document, operation),
        request: request_1.translateToRequest(accessors_1.getValidOasParameters(document, operation.parameters, pathObj.parameters), consumes),

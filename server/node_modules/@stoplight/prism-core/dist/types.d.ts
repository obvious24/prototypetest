...
declare type IPrismBaseConfig = {
    checkSecurity: boolean;
    validateRequest: boolean;
    validateResponse: boolean;
    errors: boolean;
};
export declare type IPrismMockConfig = IPrismBaseConfig & {
    mock: object;
};
export declare type IPrismProxyConfig = IPrismBaseConfig & {
    mock: false;
    upstream: URL;
};
export declare type IPrismConfig = IPrismMockConfig | IPrismProxyConfig;

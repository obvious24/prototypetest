...
const apiKeyInCookie = (input, name) => {
    var _a;
    const isApiKeyInCookie = pipeable_1.pipe(Option_1.fromNullable((_a = input.headers) === null || _a === void 0 ? void 0 : _a['cookie']), Option_1.map(cookie => new RegExp(`${lodash_1.escapeRegExp(name)}=.+`).test(cookie)), Option_1.getOrElse(() => false));

...
const validateSecurity = ({ element, resource }) => pipeable_1.pipe(O.fromNullable(resource.security), O.chain(O.fromPredicate(Array_1.isNonEmpty)), O.fold(() => E.right(element), securitySchemes => pipeable_1.pipe(getValidationResults(securitySchemes, element), E.bimap(e => [setErrorTag(e)], () => element))));

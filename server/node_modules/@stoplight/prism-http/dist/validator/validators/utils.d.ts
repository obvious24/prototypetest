...
export declare const validateAgainstSchema: (value: unknown, schema: JSONSchema, coerce: boolean, prefix?: string | undefined) => O.Option<NonEmptyArray<IPrismDiagnostic>>;

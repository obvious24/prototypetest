...
const PreferencesDecoder = D.partial({
    code: pipeable_1.pipe(D.string, IntegerFromString),
    dynamic: pipeable_1.pipe(D.string, BooleanFromString),
    example: D.string,
});
const getHttpConfigFromRequest = (req) => {
    ...
    return pipeable_1.pipe(PreferencesDecoder.decode(preferences), E.bimap(err => prism_http_1.ProblemJsonError.fromTemplate(prism_http_1.UNPROCESSABLE_ENTITY, D.draw(err)), parsed => ({ code: parsed === null || parsed === void 0 ? void 0 : parsed.code, exampleKey: parsed === null || parsed === void 0 ? void 0 : parsed.example, dynamic: parsed === null || parsed === void 0 ? void 0 : parsed.dynamic })));
};
